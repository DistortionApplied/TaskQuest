  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Set up a reward and the tasks needed to earn it</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Required Tasks</h2>
              ...
              <div key={task.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <label className="text-sm font-medium text-gray-700">XP Value:</label>
                    <Input
                      type="number"
